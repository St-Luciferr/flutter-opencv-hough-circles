            ...
            try {
                ...
                if (circles.cols() > 0) {
                    for (x in 0 until circles.cols()) {
                        ...
                        println("--> 54 circleVec[1]  " + circleVec[0].toString())
                        println("--> 55 circleVec[1] " + circleVec[1].toString())
                        val radius = circleVec[2].toInt()
                        println("--> 55 radius " + radius.toString())

                        println("--> 55 centerColor " + centerColor.toString())
                        println("--> 55 centerWidth " + centerWidth.toString())
                        println("--> 55 circleColor " + circleColor.toString())
                        println("--> 55 circleWidth " + circleWidth.toString())
                        Imgproc.circle(src, center, 3, Scalar(255.0,0.0,0.0), centerWidth)
